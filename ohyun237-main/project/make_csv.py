...
filename           = 'ard_sensor_daq_log.csv'
...
while sentry:
    ...
    log_file_text2 = tempvalueslist[0] + seperator + tempvalueslist[1] + seperator +tempvalueslist[2]
    log_file_text3 = log_file_text2 + '\n'
